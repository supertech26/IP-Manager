...
export function Login() {
    ...
    return (
        <div style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-app)', color: 'var(--text-primary)' }}>
            <form onSubmit={handleSubmit} style={{ background: 'var(--bg-surface)', padding: '2.5rem', borderRadius: 'var(--radius-xl)', border: '1px solid var(--border-subtle)', width: '100%', maxWidth: '400px', boxShadow: 'var(--shadow-glow)' }}>
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)', marginTop: '0.3rem' }}>Sign in to your account</p>
                </div>
                ...
                <div style={{ display: 'grid', gap: '1.25rem' }}>
                    ...
                    <button type="submit" disabled={loading} className="btn btn-primary" style={{ marginTop: '1.5rem', width: '100%', justifyContent: 'center', height: '48px', fontSize: '1rem', fontWeight: 600 }}>
